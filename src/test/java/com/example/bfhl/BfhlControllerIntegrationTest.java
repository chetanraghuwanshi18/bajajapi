...
class BfhlControllerIntegrationTest {
    ...
    void postBfhl_standardInput_returns200() throws Exception {
        ...
        mockMvc.perform(post("/bfhl")
                ...
                .andExpect(jsonPath("$.user_id").value("chetan_raghuwanshi_17122004"))
                .andExpect(jsonPath("$.email").value("chetanraghuwanshi23083838@acropolis.in"))
                .andExpect(jsonPath("$.roll_number").value("0827CS231065"))
